...
//		// Mapa para ordenar os APs pela força de sinal (do maior para o mais
//		// pequeno)
//		Map<Integer, ScanResult> aps = new TreeMap<Integer, ScanResult>();
//		aps = sortList(results);
//
//		// Mapa para guardar o nó de ocorrçncia das localizaçães, ordenado por
...
//		// Obter a localização com maior nó de ocorrências
...
//					"You are at room " + location, Toast.LENGTH_SHORT).show();
	...
	private Map<Integer, ScanResult> sortList(List<ScanResult> results) {
		// Criar o mapa com o comparador que ordena o mapa por força de sinal
	...
	// Comparador para ordenar o mapa com as localizaçães por valor (do maior
	// para o mais pequeno)
	...
	// Comparador para ordenar o mapa com os APs por força de sinal (do maior
	// para o mais pequeno)
