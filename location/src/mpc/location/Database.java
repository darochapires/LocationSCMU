...
public class Database extends SQLiteOpenHelper {
  ...
  private static final String DATABASE_CREATE = "create table "
      ...
      + "text not null, " + ACCESSPOINT_ADDRESS
      + "text not null, " + ACCESSPOINT_STRENGTH
      + "integer, " + ACCESSPOINT_LOCATION_ID
      + "integer);";
  ...
  public void insert_location(String location_name, String ap_name, int strength, String address) {
